(function($) {
    ...
    passwordInput.oninput= function(){
		...
		if(passwordValue != ""){
			...
			if(whitespace)
			{
				passwordInfo.textContent = "공백은 허용하지 않습니다.";
			}
			else {
		...
		function poorPasswordStrength(passwordLength, poorPassword, weakPassword, strongPassword){
			if(passwordLength < 8)
			{
			   ...
			   passwordInfo.innerHTML  = '<img src="/assets/img/icon/angry.svg" class="me-2">' + "Weak. 8자 이상 입력하세요.";
		...
		function weakPasswordStrength(passwordLength, poorPassword, weakPassword, strongPassword){
			if(passwordLength >= 8 && (poorPassword || weakPassword || strongPassword))
			{
			   ...
			   passwordInfo.innerHTML = '<img src="/assets/img/icon/anguish.svg" class="me-2">' + "Average. 최소 1개의 문자 또는 숫자를 포함해야 합니다.";
		   ...
		   if(passwordLength>= 8 && poorPassword && (weakPassword || strongPassword))
			{
			 ...
			 passwordStrength.classList.remove("heavy-active");
			 passwordInfo.innerHTML = '<img src="/assets/img/icon/smile.svg" class="me-2">' + "Almost. 특수 기호를 포함해야 합니다.";
		  ...
		  if(passwordLength >= 8 && (poorPassword && weakPassword) && strongPassword)
			{
			 ...
			 passwordInfo.innerHTML = '<img src="/assets/img/icon/smile.svg" class="me-2">' + "Awesome! 사용가능한 비밀번호 입니다.";
    ...
    passwordInput1.oninput= function(){
		...
		if(passwordValue1 != ""){
			...
			if(whitespace1)
			{
				passwordInfos.textContent = "공백은 허용하지 않습니다.";
			}
			else {
		...
		function poor1Password1Strength1(passwordLength1, poor1Password1, weak1Password1, strong1Password1){
			if(passwordLength1 < 8)
			{
			   ...
			   passwordInfos.innerHTML  = '<img src="/assets/img/icon/angry.svg" class="me-2">' + "weak1. 8자 이상 입력하세요.";
		...
		function weak1Password1Strength1(passwordLength1, poor1Password1, weak1Password1, strong1Password1){
			if(passwordLength1 >= 8 && (poor1Password1 || weak1Password1 || strong1Password1))
			{
			   ...
			   passwordInfos.innerHTML = '<img src="/assets/img/icon/anguish.svg" class="me-2">' + "Average. 최소 1개의 문자 또는 숫자를 포함해야 합니다.";
		   ...
		   if(passwordLength1>= 8 && poor1Password1 && (weak1Password1 || strong1Password1))
			{
			 ...
			 passwordStrength1.classList.remove("heavy-active");
			 passwordInfos.innerHTML = '<img src="/assets/img/icon/smile.svg" class="me-2">' + "Almost. 특수 기호를 포함해야 합니다.";
		  ...
		  if(passwordLength1 >= 8 && (poor1Password1 && weak1Password1) && strong1Password1)
			{
			 ...
			 passwordInfos.innerHTML = '<img src="/assets/img/icon/smile.svg" class="me-2">' + "Awesome! 사용가능한 비밀번호 입니다.";
