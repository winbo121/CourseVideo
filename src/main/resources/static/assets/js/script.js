/*
Author       : hhj
Template Name: KOTECH LMS - Bootstrap Template
Version      : 1.0
*/
...
(function($) {
	...
	if ($('#editor').length > 0) {
		CKEDITOR.ClassicEditor.create(document.getElementById("editor"), {
                ...
                toolbar: {
                    items: [
                        'exportPDF','exportWord', '|',		// PDF 변환 다운로드
                        'findAndReplace', 'selectAll', '|', // 찾기
                        'heading', '|',						// 헤딩
                        'bold', 'italic', 'strikethrough', 'underline', 'code', 'subscript', 'superscript', 'removeFormat', '|', // 글자 폰트
                        'bulletedList', 'numberedList', 'todoList', '|', // 목록옵션
                        'outdent', 'indent', '|',	// 들여쓰기
                        'undo', 'redo', // 이전, 다음
                        '-',
                        'fontSize', 'fontFamily', 'fontColor', 'fontBackgroundColor', 'highlight', '|', // 폰트 사이즈 및 폰트 스타일
                        'alignment', '|', // 정렬
                        'link', 'insertImage', 'blockQuote', 'insertTable', 'mediaEmbed', 'codeBlock', 'htmlEmbed', '|', // 링크 & 이미지 업로드 & 표 만들기 ...
                        'specialCharacters', 'pageBreak', '|',  //'horizontalLine', // 특수문자 및 페이지 나누기
                        //'textPartLanguage', '|',
                        'sourceEditing' // 소스코드 보기
                    ],
                ...
                fontSize: {
                    options: [6, 8, 9, 10, 12, 14, 'default', 18, 20, 22, 24, 28, 32, 44, 50],
                    supportAllValues: true
                },
