...
<div id="app">
	...
	<form:form modelAttribute="signup">
		...
		<div id="text1" tabindex="0" style="overflow:scroll; overflow-x: hidden; width:100%; height:140px; padding:15px; border:1px solid #c8c8c8; font-size: 0.750rem; line-height: 1.5em;">
		      ...
		      <br>
		      제1조 (목적)<br>
		       이 약관은 SYSTEM이 운영하는 “LMS” (이하 ‘당 사이트’)가 제공하는 모든 회원정보 서비스(이하 '서비스')를 이용하는 고객(이하 ‘회원’)과 ‘당 사이트’가 ‘서비스’의 이용에 관한 조건 및 절차와 기타 필요한 사항을 규정하는 것을 목적으로 합니다.<br>
		      제2조 (약관의 효력과 변경)<br>
		      <br>
		      ...
		       ② '당 사이트'는 '서비스'가 계속적이고 안정적으로 운영될 수 있도록 노력하며, 부득이한 이유로 '서비스'가 중단되면 지체없이 이를 수리 복구하는 데 최선을 다해 노력합니다. 다만, 천재지변, 비상사태, 시스템 정기점검 및   필요한 경우에는 그 서비스를 일시 중단하거나 중지할 수 있습니다.<br>
		      <br>
		      제 12조(`회원` 정보 사용에 대한 동의)<br>
		      <br>
		       ① 당 사이트 이외에 각종 사이트를 운영하고 있는 바,운영하는 메인 사이트 및 각종 서브사이트의 서비스 제공을 목적으로 회원의 정보를 수집하며, 수집된 회원의 정보를 사용할 수 있습니다.<br>
		      ...
		       ③ 자신의 아이디(ID)가 부정하게 사용된 경우, '회원'은 반드시 사실을 통보해야 합니다.<br>
		      ...
		      <br>
		      제17조 (면책)<br>
		       	 천재지변 또는 불가피한 사정으로 '서비스'를 중단할 경우, '회원'에게 발생되는 문제에 대해 책임을 지지 않습니다.<br>
		      제18조 (관할법원)<br>
		       ① '서비스' 이용과 관련하여 소송이 제기될 경우 의 소재지를 관할하는 법원 또는 대한민국의 민사소송법에 따른 법원을 관할법원으로 합니다.<br>
		...
		<div id="text1" tabindex="0" style="overflow:scroll; overflow-x: hidden; width:100%; height:140px; padding:15px; border:1px solid #c8c8c8; font-size: 0.750rem; line-height: 1.5em;">
		      ...
		      <br>
		      제1조 (목적)<br>
		       이 약관은  운영하는 “LMS” (이하 ‘당 사이트’)가 제공하는 모든 회원정보 서비스(이하 '서비스')를 이용하는 고객(이하 ‘회원’)과 ‘당 사이트’가 ‘서비스’의 이용에 관한 조건 및 절차와 기타 필요한 사항을 규정하는 것을 목적으로 합니다.<br>
		      제2조 (약관의 효력과 변경)<br>
		      <br>
		       ① 이 약관은 회원 가입 정보 입력화면에서 '회원'이 "동의" 버튼을 클릭함으로써 효력이 발생됩니다.<br>
		       ② ‘당 사이트’는 이 약관을 임의로 변경할 수 있으며, 변경된 약관은 적용일 전 7일간 `회원'에게 공지되고 적용 일에 효력이 발생 됩니다.<br>
		      ...
		        2. 통계작성/학술연구 또는 시장조사를 위하여 필요한 경우로서 특정 개인을 식별할 수 없는 형태로 제공하는 경우<br>
		        3. '당 사이트'는 '회원'의 전체 또는 일부 정보를 업무와 관련 된 통계 자료로 사용하는 경우<br>
		       ② '당 사이트'는 '서비스'가 계속적이고 안정적으로 운영될 수 있도록 노력하며, 부득이한 이유로 '서비스'가 중단되면 지체없이 이를 수리 복구하는 데 최선을 다해 노력합니다. 다만, 천재지변, 비상사태, 시스템 정기점검  필요한 경우에는 그 서비스를 일시 중단하거나 중지할 수 있습니다.<br>
		      <br>
		      제 12조(`회원` 정보 사용에 대한 동의)<br>
		      <br>
		       ①  당 사이트 이외에 각종 사이트를 운영하고 있는 바,운영하는 메인 사이트 및 각종 서브사이트의 서비스 제공을 목적으로 회원의 정보를 수집하며, 수집된 회원의 정보를 사용할 수 있습니다.<br>
		      ...
		       ① 아이디와 비밀번호의 관리에 대한 책임은 '회원'에게 있습니다.<br>
		       ② '회원'은 자신의 아이디를 타인에게 양도, 증여, 대여하거나 타인으로 하여금 사용하게 하여서는 아니됩니다.<br>
		       ③ 자신의 아이디(ID)가 부정하게 사용된 경우, '회원'은 반드시  그 사실을 통보해야 합니다.<br>
		       ④ '회원'은 게시물에 등록된 데이터를 이용한 영업활동을 할 수 없습니다.<br>
		       ⑤ '회원'은 '당 사이트'가 보내는 공지 메일을 수신해야 합니다.<br>
		      <br>
		      제14조 (회원의 게시물)<br>
		      ...
		       	 천재지변 또는 불가피한 사정으로 '서비스'를 중단할 경우, '회원'에게 발생되는 문제에 대해 책임을 지지 않습니다.<br>
		      제18조 (관할법원)<br>
		       ① '서비스' 이용과 관련하여 소송이 제기될 경우의 소재지를 관할하는 법원 또는 대한민국의 민사소송법에 따른 법원을 관할법원으로 합니다.<br>
		       ② 본 약관의 해석과 적용 및 본 약관과 관련한 분쟁의 해결에는 대한민국법이 적용됩니다.<br>
		</div>
		<div style="text-align: right; margin-top:5px;">
